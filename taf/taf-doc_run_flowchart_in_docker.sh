...
cd /docker_now; python3 ${DOCKER_GIT}/sample-mako.py --infile=${DOCKER_GIT}/class.flowchart.mako --service="${DOCKER_MODULE} Service"  --plantumlServerProxy="http://tiger02.lge.com:18080/proxy?fmt=svg"  --tcmdoutdir=${DOCKER_OUT} --outfile="index.html"
